...
<%
    ...
    String role = (session != null) ? (String) session.getAttribute("rol") : null;
%>
...
<div class="login-container">
    ...
    <!-- Si el usuario tiene rol 'admin', mostrar el botón de agregar usuario -->
    <% if ("admin".equals(role)) { %>
    <a href="agregarUsuario.jsp" class="btn btn-secondary w-50">
    ...
    <% if ("admin".equals(role)) { %>
    <a href="consulta.html" class="btn btn-secondary w-50">
        <i class="fas fa-search"></i> Ir a Consultas
    </a>
    <% } else { %>
    <a href="consultaUsuario.html" class="btn btn-secondary w-50">
        <i class="fas fa-search"></i> Ir a Consultas
    </a>
    <% } %>
